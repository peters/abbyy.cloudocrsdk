...
$platforms | ForEach-Object {
    ...
    Build-Project -project $rootFolder\src\abbyy.cloudocrsdk\Abbyy.CloudOcrSdk.csproj `
   ...
   -platform $platforms
    ...
    Build-Nupkg -project $rootFolder\src\abbyy.cloudocrsdk\Abbyy.CloudOcrSdk.csproj `
